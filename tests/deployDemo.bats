...
@test "deployDemo - it should generate a correct <demo>.config" {
    result="$(./infra.sh deployDemo testBranch 200 testUser http://foobar/PR 700 | grep -v timestamp)"
...
@test "deployDemo - it should rotate builds by build number" {
    ./infra.sh deployDemo testBranch 200 testUser http://foobar/PR 700
    ./infra.sh deployDemo testBranch 201 testUser http://foobar/PR 700
    ./infra.sh deployDemo testBranch 208 testUser http://foobar/PR 700
...
@test "deployDemo - it should rotate demos by timestamp" {
    ./infra.sh deployDemo demo1 200 testUser http://foobar/PR 700
    sleep 1 # With cached curl calls we might return here in under a second and end up with the same timestamp => sleep
    ./infra.sh deployDemo demo2 201 testUser http://foobar/PR 700
    sleep 1
    ./infra.sh deployDemo demo3 208 testUser http://foobar/PR 700
    result="$(cat $OVERVIEW_TARGET_DIR/demos.json | grep -v timestamp)"
